...
class TBM(BaseSmtModel):
    ...
    REQUIRED_CSV_FIELDS = (
        'code', 'manifacturer', 'alignment_set_code', 'pk_start', 'pk_end',
        # TODO: piuttosto che metterle obbligatorie abilito o disabilito calcoli relativi?
        # da smart_tunneling
        'type', 'dstype', 'shield_length', 'frontShieldLength', 'frontShieldDiameter',
        'tailShieldDiameter', 'excav_diameter', 'overcut', 'loadPerCutter', 'cutterCount',
        'cutterSize', 'cutterSpacing', 'cutterThickness', 'referenceRpm', 'nominalTorque',
        'breakawayTorque', 'backupDragForce', 'nominalThrustForce', 'auxiliaryThrustForce',
        'openingRatio', 'cutterheadThickness',
        # da smt
        'bead_thickness', 'taper', 'tail_skin_thickness', 'delta', 'gamma_muck', 'pressure_max')

    # TODO: invertire questa funzione inserirla in alignmentset
