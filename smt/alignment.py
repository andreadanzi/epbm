...
#                """
                if "BUILDINGS" in self.item:                    
                    for idx, b in enumerate(align.BUILDINGS):
                        ...
                        bldg_curr = DamageParametersBurlandWroth(x_min, x_max, str_type, bldg_h, z)
                        bldg_curr.update_geo(r_excav, depth_tun, beta_tun, nu_tun)
                        bldg_curr.update_stress(eps0_b)
                        building_item["vulnerability_base"] = bldg_curr.esp_crit
                        ...
                        building_item["esp_crit"] = bldg_curr.esp_crit
