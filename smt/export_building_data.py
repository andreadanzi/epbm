...
def export_buildings_data(project_code, authenticate, csv_name, shp_name, fields_name, epsg):
    '''
...
def main(argv):
    ...
    for opt, arg in opts:
        if opt == '-h':
            ...
            fields_name = arg
    export_buildings_data(project_code, authenticate, csv_name, shapefile_name, fields_name, epsg)
